Feature: verify the adactin login details
  ...
  Scenario Outline: verify the adactin loginwith valid credentiles
    ...
    Examples: 
      ...
      | praveen05 | praveen@05 | London   | Hotel Sunshine | Standard | 7 - Seven | 20/01/2021  | 27/01/2021   | 3 - Three    | 3 - Three    | sanjay    | vinod    | Annagar        | 1212121212123414 | American Express | April | 2021 | 1227 |
